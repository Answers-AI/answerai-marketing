...
- Replace all instances of `@answersai-marketing` to be the main package name i.e `@answersai-marketing -> @custom-website` (make sure to ignore this file)
...
- All package.json should be the exact same across all projects\* so accept all changes and ensure that the scripts are using customer packages and not @answersai-marketing
...
- Common issues:
  - `@answersai-marketing/web:dev: Module not found: Can't resolve '../components/GoogleFormIntegration/GoogleFormIntegration.theme'`
